...
```bash
/Users/amitri/Projects/LTX-Video/scripts/run_video_pipeline.sh "Black-Scholes options pricing" --stage research --work-dir /path/to/your-project
```
...
- The new flow is topic -> research -> scripts -> render -> tts -> stitch.
